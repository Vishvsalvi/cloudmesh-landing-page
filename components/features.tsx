...
const featuredCard = [
  ...
  // },
  {
    ...
    subtitle: "Sync your files with the click of a button. No more switching between tabs.",
    type: 'featured',
  ...
  },
  {
    ...
    subtitle: "CloudMesh is designed to be fast and minimal, so you can focus on your work.",
    type: 'featured',
        ...
        <div className="mx-auto max-w-screen-lg px-4 md:px-8">
          ...
          >
            <div className="relative z-10">
              ...
              CloudMesh solves the everyday challenges of working with multiple cloud storage providers.
              </p>
            </div>
            <div
            ...
            >
              <div className="bg-background rounded-2xl border border-border p-6 shadow-sm max-w-md mx-auto lg:mx-0 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className=" rounded-xl h-64 flex items-center justify-center">
                  <img src={item.image} alt={item.title} className="w-full h-full object-cover scale-110 rounded-xl" />
                </div>
              </div>
            </motion.div>
            ))}
